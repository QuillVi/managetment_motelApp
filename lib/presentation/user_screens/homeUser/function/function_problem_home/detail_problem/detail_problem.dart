...
class DetailProblemUser extends StatefulWidget {
  final int problemId;
  const DetailProblemUser({super.key, required this.problemId});

  @override
  State<DetailProblemUser> createState() => _DetailProblemUserState();
}

class _DetailProblemUserState extends State<DetailProblemUser> {
  @override
  void initState() {
    super.initState();
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              leading: IconButton(
                ...
                onPressed: () {
                  getIt<AppRouter>().push(ProblemHomeUser());
                },
              ),
              title: const Text(
                'Sự cố',
