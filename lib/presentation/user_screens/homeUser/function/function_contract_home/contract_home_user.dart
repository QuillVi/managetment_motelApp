...
class ContractHomeUser extends StatefulWidget {
  const ContractHomeUser({super.key});

  @override
  State<ContractHomeUser> createState() => _ContractHomeUserState();
}

class _ContractHomeUserState extends State<ContractHomeUser> {
  @override
  void initState() {
    super.initState();
